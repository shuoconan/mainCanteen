...
public class LoginFrame implements MouseListener,ListSelectionListener{
    ...
    private Font font = new Font("ºÚÌå", Font.BOLD, 60);
	...
	public void initLoginFrame(String bgPathname){
		...
		//È¡ÍâÂô°´Å¥
		this.jLabel_wm = new JLabel("Íâ Âô");
		...
		this.userlist.add("¹ËÑô");
		this.userlist.add("ÑÕ×³");
		...
		this.userJList = new JList<String>(new String[]{"¹ËÑô","ÑÕ×³"});
		this.userJList.setFont(new Font("ºÚÌå", Font.BOLD, 40));
